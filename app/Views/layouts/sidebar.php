<aside class="w-64 bg-gradient-to-b from-emerald-800 to-emerald-900 min-h-screen text-white">
  <nav class="mt-8">
    <ul class="space-y-2 px-4">
      <li>
        <a href="<?= base_url('admin') ?>" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-lg active">
      ...
      <li>
        <a href="<?= base_url('admin/dashboard_admin/extras') ?>" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-lg">
